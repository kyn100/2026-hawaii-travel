...
export const placesBase: Record<string, {
  ...
  'diamond-head': {
    ...
    category: 'nature',
    images: [
      'https://images.unsplash.com/photo-1598135753163-6167c1a1ad65?w=800',
      'https://images.unsplash.com/photo-1559041881-74dd9fd9b600?w=800',
    ],
  ...
  'pearl-harbor': {
    ...
    category: 'historic',
    images: [
      'https://images.unsplash.com/photo-1563875375674-96c12e1a3d9e?w=800',
  ...
  'north-shore': {
    ...
    images: [
      ...
      'https://images.unsplash.com/photo-1518378188025-22bd89516ee2?w=800',
    ],
  ...
  'hawaii-volcanoes': {
    ...
    images: [
      ...
      'https://images.unsplash.com/photo-1608408891905-d5e6e16f2159?w=800',
    ],
  ...
  'road-to-hana': {
    ...
    category: 'adventure',
    images: [
      'https://images.unsplash.com/photo-1483168527879-c66136b56105?w=800',
